 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Segments" type="{http://schemas.datacontract.org/2004/07/LetGoBikingService.Models}ArrayOfSegment" minOccurs="0"/&gt;
 *         &lt;element name="Summary" type="{http://schemas.datacontract.org/2004/07/LetGoBikingService.Models}Summary" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Properties {
    ...
    @XmlElementRef(name = "Segments", namespace = "http://schemas.datacontract.org/2004/07/LetGoBikingService.Models", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfSegment> segments;
    @XmlElementRef(name = "Summary", namespace = "http://schemas.datacontract.org/2004/07/LetGoBikingService.Models", type = JAXBElement.class, required = false)
