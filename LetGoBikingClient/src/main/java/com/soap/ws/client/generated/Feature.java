 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Properties" type="{http://schemas.datacontract.org/2004/07/LetGoBikingService.Models}Properties" minOccurs="0"/&gt;
 *         &lt;element name="geometry" type="{http://schemas.datacontract.org/2004/07/LetGoBikingService.Models}Geometry" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Feature {
    ...
    @XmlElementRef(name = "Properties", namespace = "http://schemas.datacontract.org/2004/07/LetGoBikingService.Models", type = JAXBElement.class, required = false)
    protected JAXBElement<Properties> properties;
    @XmlElementRef(name = "geometry", namespace = "http://schemas.datacontract.org/2004/07/LetGoBikingService.Models", type = JAXBElement.class, required = false)
